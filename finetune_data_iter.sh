...
for DATASET in "${DATASETS[@]}"; do
    ...
    python nnunetv2/run/run_finetuning_STUNet.py \
        ...
        3d_fullres \
        0 \
        -pretrained_weights "/nas_homes/yoonji/medmask/nnUNet_results/pretraining/single_epistemic/0.6/single_epistemic_checkpoint_epoch_500.pt" \
        -tr STUNetTrainer \
        -device cuda \
        --dataset_name "$DATASET" \
        --result_folder medmask_singleepistemic_0616
