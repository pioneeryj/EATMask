...
if __name__ == '__main__':
    ...
    for file in file_path:
        ...
        num_classes = None
        dice_score = calculate_dice_score(ret, label_)
        # nsd_score = calculate_nsd_score(ret, label_, threshold=1.0, num_classes=None)
        idx+=1
        print(idx,"dice score: ",dice_score) #"nsd_score: ", nsd_score)
