...
#     3d_fullres \
#     0 \
#     -pretrained_weights "/nas_homes/yoonji/medmask/nnUNet_results/pretraining/spark/Spark_checkpoint_epoch_1000.pt" \
#     -tr STUNetTrainer \
#     -device cuda \
...
python nnunetv2/run/run_finetuning_STUNet.py \
    ...
    -device cuda \
    --dataset_name Dataset309_FLARE22 \
    --result_folder anatomask_1000_0619