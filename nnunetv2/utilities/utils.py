...
def get_filenames_of_train_images_and_targets(raw_dataset_folder: str, dataset_json: dict = None):
    ...
    if 'dataset' in dataset_json.keys():
        ...
        #images = [join(raw_dataset_folder, 'imagesTr', i +'_0000'+ dataset_json['file_ending']) for i in identifiers]
...
if __name__ == '__main__':
    print(get_filenames_of_train_images_and_targets(join(nnUNet_raw, 'Dataset309_FLARE22')))
