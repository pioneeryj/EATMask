...
output_folder = '/home/yoonji/AnatoMask/Anatomask_results/Dataset601_Total/Pretraining/0224/' + model_name
...
for i in range(start_epoch,epoch):
    ...
    for idx in range(iters_train):
        ...
        inp = next(mt_gen_train) # 현재 상태에서 다음 데이터를 반환하고, 반환한 다음에 상태를 다음 항목으로 이동시킴(내부의 iterator 프로토콜콜)
        inp = inp['data']
